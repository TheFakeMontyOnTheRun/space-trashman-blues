...
void drawBillboardAt(const struct Vec3 center,
    ...
    drawMask(ulz0.mX, ulz0.mY, lrz0.mX, lrz0.mY, 48);
}
...
void drawColumnAt(const struct Vec3 center,
  ...
  */
    ...
    if ((mask & MASK_BEHIND) || (enableAlpha && (mask & MASK_FRONT))) {
        drawMask(p2.mX, p2.mY, p3.mX, p3.mY, 64);
    }
    ...
    if (((mask & MASK_RIGHT) && fixToInt(center.mX) > 0) || (mask & MASK_FORCE_RIGHT)) {
        ...
        maskWall(p2.mX, p0.mX, p2.mY, p3.mY, p0.mY, p1.mY, 64);
    ...
    if (((mask & MASK_LEFT) && fixToInt(center.mX) < 0) || (mask & MASK_FORCE_LEFT)) {
        ...
        maskWall(p1.mX, p3.mX, p0.mY, p1.mY, p2.mY, p3.mY, 64);
    ...
    if ((mask & MASK_FRONT)) {
        ...
        drawMask(p0.mX, p0.mY, p1.mX, p1.mY, 64);
    }
}
...
void drawLeftNear(const struct Vec3 center,
    ...
    if (mask & MASK_BEHIND) {
        ...
        drawMask(projectionVertices[0].second.mX, projectionVertices[0].second.mY,
                 projectionVertices[1].second.mX, projectionVertices[1].second.mY, 32);
    ...
    maskWall(ulz0.mX, urz0.mX, ulz0.mY, llz0.mY, urz0.mY, lrz0.mY, 32);
}
...
void drawRightNear(const struct Vec3 center,
    ...
    maskWall(ulz0.mX, urz0.mX, ulz0.mY, llz0.mY, urz0.mY, lrz0.mY, 48);
}
