...
public class Exportable : MonoBehaviour
{
    ...
    public enum GeometryType { None, Cube, LeftNear, LeftFar, WallNorth, WallWest, WallCorner, RampNorth, RampEast, RampSouth, RampWest};
