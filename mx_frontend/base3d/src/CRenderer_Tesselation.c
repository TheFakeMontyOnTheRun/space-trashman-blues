...
void drawRampAt(const struct Vec3 p0,
...
#else
        drawFloor(llz1.mY, lrz0.mY, llz1.mX, lrz1.mX, llz0.mX, lrz0.mX, fixToInt(p0.mZ), texture->rotations[0], tint );
#endif
    }
}
...
void drawMesh(const struct Mesh *mesh,
